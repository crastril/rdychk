    ...
    return (
        ...
        >
            <div className="flex items-center space-x-2 border p-4 rounded-lg cursor-pointer hover:bg-muted/50 transition-colors">
                <RadioGroupItem value="remote" id={`${baseId}-remote`} />
                <div className="flex-1 cursor-pointer" onClick={() => !disabled && onValueChange('remote')}>
                    <Label htmlFor={`${baseId}-remote`} className="cursor-pointer font-semibold text-base">À distance</Label>
            ...
            <div className="flex items-center space-x-2 border p-4 rounded-lg cursor-pointer hover:bg-muted/50 transition-colors">
                <RadioGroupItem value="in_person" id={`${baseId}-in_person`} />
                <div className="flex-1 cursor-pointer" onClick={() => !disabled && onValueChange('in_person')}>
                    <Label htmlFor={`${baseId}-in_person`} className="cursor-pointer font-semibold text-base">Sur place</Label>
                    <p className="text-sm text-muted-foreground mt-1">
